...
$variables = array(
		...
		//URLS
		'RETURNURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/billingagreements\/setexpresscheckout-ba.php/','getexpresscheckout.php',$_SERVER['SCRIPT_NAME']),
		'CANCELURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/billingagreements\/setexpresscheckout-ba.php/','cancel.php',$_SERVER['SCRIPT_NAME']),
