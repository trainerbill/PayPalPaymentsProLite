...
$variables = array(
		...
		//URLS
		'RETURNURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/setexpresscheckout.php/','getexpresscheckout.php',$_SERVER['SCRIPT_NAME']),
		'CANCELURL' => 'http://'.$_SERVER['HTTP_HOST'].preg_replace('/setexpresscheckout.php/','cancel.php',$_SERVER['SCRIPT_NAME']),
