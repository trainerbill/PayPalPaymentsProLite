...
<div class="alert alert-danger">
	...
	<div>In order to use the hosted layout you must setup your manager account properly. <a href="../instructions.php?layout=b">Instructions</a></div>
</div>
...
<div class="row">
	<div class="col-md-12">
		<h3>Redirect to PayPal</h3>
		<pre>
			<code>
header('Location: <?php echo $gettok->getHostedEndpoint();?>?SECURETOKEN=<?php echo $rvars['SECURETOKEN'] ?>&SECURETOKENID=<?php echo $rvars['SECURETOKENID'] ?>');
			</code>
		</pre>
	</div>
</div>
...
<div>
	<a class="btn btn-default" href="<?php echo $gettok->getHostedEndpoint(); ?>?SECURETOKEN=<?php echo $rvars['SECURETOKEN'] ?>&SECURETOKENID=<?php echo $rvars['SECURETOKENID'] ?>">Redirect To PayPal</a>
